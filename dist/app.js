...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = function Slide(_ref) {
	  ...
	  IncrementalDOM.elementOpen('div', key);IncrementalDOM.text('hello');IncrementalDOM.elementClose('div');;
	};

	var App = function App() {
	  IncrementalDOM.elementOpen('div');IncrementalDOM.elementOpen('span');IncrementalDOM.text('hello world');IncrementalDOM.elementClose('span');IncrementalDOM.elementOpen('div');IncrementalDOM.text([1, 2, 3].forEach(function (index) {
	        return Slide({
	          key: index
	        });;
	      }) || '');IncrementalDOM.elementClose('div');IncrementalDOM.elementClose('div');;
	};

	_incrementalDom2['default'].patch(APP, App);
